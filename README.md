...
5. Print the fibonnacci series up to n terms (loop+ recursion versions)
7. Find the GCD and LCM of two numbers.
8. Swap two numbers with and without a temporary variable
9. Check if a number is Armstrong number (eg 153 = 1^3 + 5^3 + 3^3)
...
5. Write a program to dynamically allocate memory for an array using malloc and find its average.
